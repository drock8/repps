...
> Context for Codex. Read this first every session.
...
Solo founder Derrick (drock8). Lives in browser-first PWAs on Supabase + Vite + React + TypeScript + Tailwind. Works with Codex as primary collaborator. Brand palette: warm bone, deep graphite, burnt orange.
