-- Fix get_user_rank to include age/country filters matching get_leaderboard
-- Without these, the pinned rank card computes rank against a different
-- population than the visible leaderboard list.
