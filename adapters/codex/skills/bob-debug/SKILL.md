...
For local artifact fallback, inspect only file presence/mtimes under `~/bounty-agent-sessions/[target_domain]` plus Codex session log files needed for `--deep`; do not dump protected raw Bob artifacts.
